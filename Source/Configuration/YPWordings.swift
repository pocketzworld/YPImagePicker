...
public struct YPWordings {
    ...
    public var warningImageUnavailable = ypLocalized("YPImagePickerWarningImageUnavailable")
    public var warningImagePickerError = ypLocalized("YPImagePickerWarningImagePickerError")
}
